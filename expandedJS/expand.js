...
function createButton (left,text) {
	btn = document.createElement('button');
	span = document.createElement('span');
	div = document.createElement('div');
	btn.appendChild(span);
	btn.appendChild(div);
	document.getElementById("page-header").insertBefore(btn, document.getElementById("site-info"));
...
if (homePageURLs.includes(location.href)) {
	...
	createAvatarBox();
	let btnEnterBlog= createButton('25vw','Enter my blog');
	let btnEnterLab = createButton('65vw','Enter my FE-lab');
